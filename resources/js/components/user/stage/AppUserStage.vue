<template>
    <div class="user-stage">
        ...
        <div class="user-stage__header">
            <div class="user-stage__title">{{stage.title}}</div>
        ...
        <div class="user-stage__date">
            Начало регистрации: {{time(stage.register_start)}}
            <br>
            Окончание регистрации: {{time(stage.register_end)}}
            <br>
            Начало гонок: {{time(stage.race_start)}}
        </div>
